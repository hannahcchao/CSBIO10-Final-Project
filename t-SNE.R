...
# Scale/standardize features so huge numbers don't dominate the data
...
# Initialize dataframe and map the reduced dimensions
tsne_df <- data.frame(
  tSNE1     = tsne$Y[, 1],
  tSNE2     = tsne$Y[, 2], 
  Diagnosis = df$Diagnosis)

# Create scatter plot using 2D t-SNE data
